...
public class NiSurveyQuestion implements Serializable{
	...
	public String toString() {
		return "NiSurveyQuestion [sqid=" + sqid + ", sqtitle=" + sqtitle
				+ ", sqnid=" + sqnid + ", titleimgurl=" + titleimgurl
				+ ", questionnum=" + questionnum + ", vieworder=" + vieworder
				+ ", questiontype=" + questiontype + ", required=" + required
				+ ", optionnum=" + optionnum + ", isselfdefine=" + isselfdefine
				+ ", correctanswer=" + correctanswer + ", option1des="
				+ option1des + ", option1link=" + option1link
				+ ", option1feedback=" + option1feedback + ", option1tagid="
				+ option1tagid + ", option2des=" + option2des
				+ ", option2link=" + option2link + ", option2feedback="
				+ option2feedback + ", option2tagid=" + option2tagid
				+ ", option3des=" + option3des + ", option3link=" + option3link
				+ ", option3feedback=" + option3feedback + ", option3tagid="
				+ option3tagid + ", option4des=" + option4des
				+ ", option4link=" + option4link + ", option4feedback="
				+ option4feedback + ", option4tagid=" + option4tagid
				+ ", option5des=" + option5des + ", option5link=" + option5link
				+ ", option5feedback=" + option5feedback + ", option5tagid="
				+ option5tagid + ", option6des=" + option6des
				+ ", option6link=" + option6link + ", option6feedback="
				+ option6feedback + ", option6tagid=" + option6tagid
				+ ", option7des=" + option7des + ", option7link=" + option7link
				+ ", option7feedback=" + option7feedback + ", option7tagid="
				+ option7tagid + ", option8des=" + option8des
				+ ", option8link=" + option8link + ", option8feedback="
				+ option8feedback + ", option8tagid=" + option8tagid
				+ ", option9des=" + option9des + ", option9link=" + option9link
				+ ", option9feedback=" + option9feedback + ", option9tagid="
				+ option9tagid + ", option10des=" + option10des
				+ ", option10link=" + option10link + ", option10feedback="
				+ option10feedback + ", option10tagid=" + option10tagid
				+ ", option11des=" + option11des + ", option11link="
				+ option11link + ", option11feedback=" + option11feedback
				+ ", option11tagid=" + option11tagid + ", option12des="
				+ option12des + ", option12link=" + option12link
				+ ", option12feedback=" + option12feedback + ", option12tagid="
				+ option12tagid + ", option13des=" + option13des
				+ ", option13link=" + option13link + ", option13feedback="
				+ option13feedback + ", option13tagid=" + option13tagid
				+ ", option14des=" + option14des + ", option14link="
				+ option14link + ", option14feedback=" + option14feedback
				+ ", option14tagid=" + option14tagid + ", option15des="
				+ option15des + ", option15link=" + option15link
				+ ", option15feedback=" + option15feedback + ", option15tagid="
				+ option15tagid + ", option16des=" + option16des
				+ ", option16link=" + option16link + ", option16feedback="
				+ option16feedback + ", option16tagid=" + option16tagid
				+ ", option17des=" + option17des + ", option17link="
				+ option17link + ", option17feedback=" + option17feedback
				+ ", option17tagid=" + option17tagid + ", option18des="
				+ option18des + ", option18link=" + option18link
				+ ", option18feedback=" + option18feedback + ", option18tagid="
				+ option18tagid + ", option19des=" + option19des
				+ ", option19link=" + option19link + ", option19feedback="
				+ option19feedback + ", option19tagid=" + option19tagid
				+ ", option20des=" + option20des + ", option20link="
				+ option20link + ", option20feedback=" + option20feedback
				+ ", option20tagid=" + option20tagid + ", option21des="
				+ option21des + ", option21link=" + option21link
				+ ", option21feedback=" + option21feedback + ", option21tagid="
				+ option21tagid + ", option22des=" + option22des
				+ ", option22link=" + option22link + ", option22feedback="
				+ option22feedback + ", option22tagid=" + option22tagid
				+ ", option23des=" + option23des + ", option23link="
				+ option23link + ", option23feedback=" + option23feedback
				+ ", option23tagid=" + option23tagid + ", option24des="
				+ option24des + ", option24link=" + option24link
				+ ", option24feedback=" + option24feedback + ", option24tagid="
				+ option24tagid + ", option25des=" + option25des
				+ ", option25link=" + option25link + ", option25feedback="
				+ option25feedback + ", option25tagid=" + option25tagid
				+ ", option26des=" + option26des + ", option26link="
				+ option26link + ", option26feedback=" + option26feedback
				+ ", option26tagid=" + option26tagid + ", comment=" + comment
				+ "]";
	}
