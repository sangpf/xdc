...
public class CheckAwardGetStatusServiceImp implements CheckAwardGetStatusService {
	...
	@Override
	public AssessOrder checkAssessAwardGetStatus(int userId,int qnId) {
//		System.out.println("userId is:"+userId);
//		System.out.println("qnId is:"+qnId);
		HashMap<String, Object> assesshashMap = new HashMap<String, Object>();
		assesshashMap.put("userId", userId);
		assesshashMap.put("qnId", qnId);
		return checkAwardGetStatusMapper.checkAssessAwardGetStatus(assesshashMap);
	}
}
