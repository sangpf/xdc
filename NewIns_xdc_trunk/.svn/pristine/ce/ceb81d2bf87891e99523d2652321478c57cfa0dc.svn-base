 ...
 */
public class SurveyDeliveryInfo {
	int deliveryId, awardMethod,awardId,awardType,awardNum,adId,qnId,qnType,answered,thumbUp,thumbDown;
	String awardName,awardLink,adImg,adLink,relatedStr1,relatedStr2,relatedStr3,relatedUrl1,relatedUrl2,relatedUrl3,resultMsg,titleTag;
	Integer lotteryId,evaluateId;
	int sqnCategory,keyQuestionNum;
	int donatePerson;
	int donateScore;
