        ...
        success: function(data) {
            ...
            if (data.showType == 1) {
                ...
                var templateTxtInput = [
                    ...
                    '      {{/qImgUrl}}',
                    '   </h5>',
                    '   <form class=\"mui-input-group\" id=\"q{{questionNum}}\" name=\"xdc-self-define\" data-id=\"{{sqId}}\" data-isRequired=\"{{required}}\" data-questionType=\"{{questionType}}\" data-textMaxVal=\"{{textMaxVal}}\" data-textMinVal=\"{{textMinVal}}\" data-textLength=\"{{textLength}}\" data-decimalDigits=\"{{decimalDigits}}\">',
                    '       <div class=\"mui-input-row selfDefine-input\">',
                    '           <textarea name=\"q{{questionNum}}\" maxlength=\"140\" placeholder=\"请输入答案\"></textarea>',
                    '       </div>',
                    '   </form>',
                    footArea,
                    '</div>'
            ...
            for (var i = 0, length = data.questions.length; i < length; i++) {
                ...
                } else if (thisQuestion.questionType>=3&&thisQuestion.questionType<=12) {
