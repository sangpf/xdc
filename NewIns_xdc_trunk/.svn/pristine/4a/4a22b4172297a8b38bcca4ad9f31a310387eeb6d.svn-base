 ...
 * 每日三更列表里item的model对象
 */
@Component(value = "Daily3UpdateItem")
public class Daily3UpdateItem {

	int deliveryId;// 投放id
	int qnId;// 问卷、测评或投票id
	int qnType;//1：问卷；2：测评；3投票
	int collectNum;// 本次投放的目标收集份数
	int collectedNum; // 本次投放的已收集份数;
	int winnerNum;// 本次投放的获奖人数;
	int awardMethod;//奖励类型：0：无奖；1：定奖；2抽奖；
	Integer lotteryId;//抽奖Id
	String showTitle;// 投放里显示的问卷标题;
	String showDes;// 投放里显示的问卷描述
	String bTime;// 投放开始时间
	String eTime;// 投放截至时间
	String publisher;// 问卷的发布机构名称
	String qnSummary;// 问卷的简介
	String img;// 投放列表项里显示的图片url
	int awardId;// 本次投放的固定奖励id
	String awardName;// 本次投放的固定奖励名称，例如充电宝
	int awardNum;// 本次投放的固定奖励数目，例如1个
	String tag1Str;// 本次投放的外标签1
	String tag2Str;// 本次投放的外标签2
	String tag3Str;// 本次投放的外标签3
	String tag4Str;// 本次投放的外标签4
	String tag5Str;// 本次投放的外标签5
	int adId;
	String adImg;
	String adLink;
	int awardType;
	String awardLink;
	int answered;
	int sqnCategory,showOrder,isTop;
	String titleTag;
	String qnClassName;
	String itemType;
	
	int reportId,viewNum,qnCollectedNum,commentNum,thumbUp,thumbDown,isFavorite;
	String reportTitle,summary,publisherName,pTime,reportUrl,reportImg,showType;
	...
	public int getQnCollectedNum() {
		return qnCollectedNum;
	}

	public void setQnCollectedNum(int qnCollectedNum) {
