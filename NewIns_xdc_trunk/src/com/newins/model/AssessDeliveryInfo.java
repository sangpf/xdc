 ...
 */
public class AssessDeliveryInfo {
	int deliveryId, awardMethod, awardId, awardType, awardNum, adId, qnId, qnType,
			answered, thumbUp, thumbDown;
	String awardName, awardLink, adImg, adLink, relatedStr1, relatedStr2,
			relatedStr3, relatedUrl1, relatedUrl2, relatedUrl3, resultMsg;
	int aqnCategory;
	Integer lotteryId;
	int donatePerson;
	int donateScore;
	int adType;
	int replaceAdId;
	String qnName,headResultDetail,tailResultDetail;
	...
	public void setDonatePerson(int donatePerson) {
	...
	public void setDonateScore(int donateScore) {
